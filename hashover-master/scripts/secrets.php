<?php
	...
	$encryption_key		= '88888888';			// Unique 8 to 32 character encryption key
	$notification_email	= 'antti.kuusinen@aalto.fi';	// E-mail for notification of new comments
	$admin_nickname		= 'anttikuu';			// Nickname with admin rights (must be title-cased)
	$admin_password		= 'password';			// Password to gain admin rights
